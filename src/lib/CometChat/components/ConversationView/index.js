            ...
            case "user": return (<div className="row">
              ...
              <div className="col cp-user-info">
                <div className="row cp-no-padding">
                  ...
                  <div className="col-lg-3 col-sm-3 cp-no-padding"><div className="cp-time text-muted"> {new Date(this.state.conversation.conversationWith.createdAt * 1000).toLocaleTimeString('en-US', { hour: 'numeric', minute: 'numeric', hour12: true })}</div></div>
                </div>
              ...
              <div className="col cp-user-info">
                <div className="row cp-no-padding">
                  ...
                  <div className="col-lg-3 col-sm-3 cp-no-padding">
                    {console.log('CONVERSATION DATE: ', this.state.conversation)}
                    <div className="cp-time text-muted"> {new Date(this.state.conversation.conversationWith.createdAt * 1000).toLocaleTimeString('en-US', { hour: 'numeric', minute: 'numeric', hour12: true })}</div>
                  </div>
                </div>
                <div className="row cp-userstatus">
                  <div className="col cp-no-padding">
