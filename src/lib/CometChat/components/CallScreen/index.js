      ...
      <div className="cp-call-screen-container">
        {this.state.showIframeScreen ? (
          <div
            ...
            className="cp-call-screen-container"
            style={{ zIndex: 100000 }}
          ></div>
        ) : null}
        {this.state.showIncomingScreen ? (
          <div className="cp-incoming-call-screen">
            ...
            <div className="m-a" style={{ display: "flex", width: "25%" }}>
              <div
                className="m-a p-xl cp-accept-button"
                onClick={() => {
                  CometChat.acceptCall(this.state.callIProgress.sessionId).then(
                    call => {
                      this.setState({
                        showCallScreen: true,
                        showIncomingScreen: false,
              ...
              <div
                className="m-a p-xl cp-reject-button"
                onClick={() => {
